---
title: "Exact Diagonalization — Iterative Lanczos (ED Lanczos)"
description: "A curated knowledge note on Exact Diagonalization — Iterative Lanczos (ED Lanczos), its assumptions, methods, limits, and verification context."
categories: [codes]
---
...
- Applicable when `D_H ≲ 10⁷–10⁸` after symmetry reduction; preferred over full ED whenever the full spectrum is not required.
...
- ED Lanczos frontier: **48–50 sites** (spin-½ kagome/triangular with full symmetry and sublattice coding) [Wietek–Läuchli, arXiv:1804.05028].
...
- `n_iter` is typically about 50 for gapped cases and can approach 500 for critical or near-degenerate cases.
