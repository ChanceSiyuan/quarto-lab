---
title: "Density-Matrix Renormalization Group (DMRG / MPS)"
description: "A curated knowledge note on Density-Matrix Renormalization Group (DMRG / MPS), its assumptions, methods, limits, and verification context."
categories: [codes]
---
...
- Best suited to one-dimensional area-law or critical states, including frustrated signful problems; disfavored for two-dimensional bulk, long real-time evolution, or volume-law states.
