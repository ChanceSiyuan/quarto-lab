---
title: "Certified Bounds — SDP / Moment-SOS Relaxations (NPA, NCTSSOS) & Bootstrap (sdp-nctssos)"
description: "A curated knowledge note on Certified Bounds — SDP / Moment-SOS Relaxations (NPA, NCTSSOS) & Bootstrap (sdp-nctssos), its assumptions, methods, limits, and verification context."
categories: [codes]
---
...
- A specialized sign-immune certification method that complements variational upper bounds.
...
- Convergence of the NPA hierarchy is guaranteed by Pironio–Navascués–Acín (2010) [@pironio_2010_convergent].
