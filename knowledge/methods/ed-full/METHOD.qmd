---
title: "Exact Diagonalization — Full (ED full)"
description: "A curated knowledge note on Exact Diagonalization — Full (ED full), its assumptions, methods, limits, and verification context."
categories: [codes]
---
...
- Applicable when `D_H ≲ 10⁷–10⁸` after symmetry reduction.
...
- Iterative Lanczos/Krylov ED reaches **48–50 sites** for spin-½ kagome or square lattices with sublattice coding and sparse matrix-vector products [Wietek–Läuchli, arXiv:1804.05028]; that frontier belongs to ED Lanczos, not full ED.
...
- Hubbard `d=4`, `N=16`: `D_H = 4^16 ≈ 4×10^9` in the full Fock space; at half-filling `D_H = C(16,8)² ≈ 1.66×10^8`, so strong symmetry reduction is required.
