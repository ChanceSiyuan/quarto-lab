---
title: "Variational Monte Carlo & Neural Quantum States (VMC-NQS)"
description: "A curated knowledge note on Variational Monte Carlo & Neural Quantum States (VMC-NQS), its assumptions, methods, limits, and verification context."
categories: [codes]
---
...
- Recommended for signful two- or three-dimensional problems that need a variational upper bound.
