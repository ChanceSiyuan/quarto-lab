---
title: "Quantum-Circuit Simulation — State-Vector, Tensor Network, Stabilizer (circuit-sim)"
description: "A curated knowledge note on Quantum-Circuit Simulation — State-Vector, Tensor Network, Stabilizer (circuit-sim), its assumptions, methods, limits, and verification context."
categories: [codes]
---
...
- Choose the engine by matching circuit entanglement to the engine's efficiency regime.
...
- TN treewidth result: Markov–Shi (2008) proved cost = `exp(treewidth)` [@markov_2008_simulating].
- Stabilizer rank exponent: `α≈0.396` (Qassim–Pashayan–Gosset 2021).
