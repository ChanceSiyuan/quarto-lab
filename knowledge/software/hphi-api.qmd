---
title: "HΦ (HPhi) — input-file API & usage reference"
description: "A curated knowledge note on HΦ (HPhi) — input-file API & usage reference, its assumptions, methods, limits, and verification context."
categories: [codes]
---
