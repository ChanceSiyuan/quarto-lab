---
title: "Kondo model (Bethe ansatz) — exact-solution oracle"
description: "A curated knowledge note on Kondo model (Bethe ansatz) — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
