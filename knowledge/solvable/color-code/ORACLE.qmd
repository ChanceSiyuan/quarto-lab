---
title: "Color code (6.6.6) — exact-solution oracle"
description: "A curated knowledge note on Color code (6.6.6) — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
