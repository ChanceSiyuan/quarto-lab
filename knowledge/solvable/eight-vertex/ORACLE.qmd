---
title: "Eight-vertex model (Baxter) — exact-solution oracle"
description: "A curated knowledge note on Eight-vertex model (Baxter) — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
