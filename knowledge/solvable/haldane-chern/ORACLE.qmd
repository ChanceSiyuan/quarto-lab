---
title: "Haldane model (Chern insulator) — exact-solution oracle"
description: "A curated knowledge note on Haldane model (Chern insulator) — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
