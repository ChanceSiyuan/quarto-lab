---
title: "Heisenberg XXX chain — exact-solution oracle"
description: "A curated knowledge note on Heisenberg XXX chain — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
...
Conventions: spin-1/2 `S`-operators (`S^a = σ^a/2`), `J = 1` antiferromagnetic, nearest-neighbour bonds counted once, `N` even. This is the isotropic (`Δ=1`) point of the XXZ family.
