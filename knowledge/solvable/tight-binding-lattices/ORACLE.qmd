---
title: "Tight-binding lattices (square, honeycomb, kagome, Lieb) — exact-solution oracle"
description: "A curated knowledge note on Tight-binding lattices (square, honeycomb, kagome, Lieb) — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
