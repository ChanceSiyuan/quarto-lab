---
title: "p+ip superconductor (lattice) — exact-solution oracle"
description: "A curated knowledge note on p+ip superconductor (lattice) — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
