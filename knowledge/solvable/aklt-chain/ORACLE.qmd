---
title: "AKLT spin-1 chain — exact-solution oracle"
description: "A curated knowledge note on AKLT spin-1 chain — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
...
Conventions: spin-1 `S`-operators (`d=3`, `S^z = +1,0,-1`); the biquadratic coefficient is fixed at `1/3` (the AKLT point); coupling is set to the energy unit `J=1`.
