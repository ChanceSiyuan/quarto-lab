---
title: "X-cube model (fracton) — exact-solution oracle"
description: "A curated knowledge note on X-cube model (fracton) — exact-solution oracle, its assumptions, methods, limits, and verification context."
categories: [theory]
---
