...
description: To estimate time-ordered correlation, we shall set up initial state as the eigenbasis of and then implement the circuit , end with a measurement of observable .
categories:
  - theory
---
