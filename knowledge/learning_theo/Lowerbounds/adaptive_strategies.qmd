...
description: Consider a restricted POVM set . In practice, we can apply POVMs from multiple times, choose their ordering strategically, and even select later measurements based on earlier outcomes.
categories:
  - theory
---
