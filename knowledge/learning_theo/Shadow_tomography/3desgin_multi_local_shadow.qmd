...
description: Now we consider the case that we can put in quantum memory and then implement randomized k-qubits Clifford gate with the -qubits gate and forms -design.
categories:
  - theory
---
...
## Proof (Click to expand)
 By
[Lemma (Onsite 2design)](intro.qmd#lem-onsite_2design)
