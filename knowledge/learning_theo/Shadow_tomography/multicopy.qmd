...
description: In the langurage of shadow tomography, this channel on the two-replica space is not invertible since if .
categories:
  - theory
---
...
# Maximum entanglement strategies{#max-entanglement-strategies}
