...
description: "A curated knowledge note on Mott Transition, its assumptions, methods, limits, and verification context."
categories: [theory]
---
...
Before interpreting evidence in a frontier regime, search recent literature with a tailored query (e.g., `2D Hubbard doped Mott transition`, `multi-orbital orbital-selective Mott`) to surface recent results. Do not commit to an identification without seeing what the literature is actually claiming.
