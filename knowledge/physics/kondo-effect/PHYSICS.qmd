---
title: "Kondo Effect"
description: "A curated knowledge note on Kondo Effect, its assumptions, methods, limits, and verification context."
categories: [theory]
---
...
- **Kondo scale estimate** — Haldane formula for symmetric Anderson:
  `T_K ~ 0.41 √(U Γ / 2) exp(-π U / 8 Γ)` (see `knowledge/limits.md`).
