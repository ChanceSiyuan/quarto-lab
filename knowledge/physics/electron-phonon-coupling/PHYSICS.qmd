---
title: "Physics: electron-phonon coupling and superconductivity"
description: "Use when interpreting electron-phonon coupling and superconductivity results — alpha2F(omega), lambda, omegalog, McMillan/Allen-Dynes Tc, and the imaginary-frequency diagnostic. This card covers the mechanism and the interpretation rules that turn spectral evidence into a qualified Tc."
categories: [theory]
---
