 ...
 * promoted. So the fixture tree under `tests/fixtures/knowledge/valid` is
 * rendered instead, and the app is rebuilt around it.
 *
 * This is a *separate script* rather than a flag on `scripts/knowledge.ts`. That
...
import { buildKnowledgeSite } from "../lib/knowledge/index.js";

const REPO_ROOT = path.resolve(fileURLToPath(import.meta.url), "..", "..");

/** The knowledge tree the browser tests describe. */
const FIXTURE_KNOWLEDGE_DIR = "tests/fixtures/knowledge/valid";

/** The bibliography those pages cite; it holds the `fixture2026` entry. */
const FIXTURE_BIBLIOGRAPHY = "tests/fixtures/knowledge/ref.bib";
