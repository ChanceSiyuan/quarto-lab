...
From the interaction-picture Hamiltonian @eq-H-interaction in [Light-Atom Interaction](light_atom.qmd), the time-evolution operator over duration $t$ (with constant $\Omega$ and $\delta$) in the rotating frame is
