...
2. **Post-selection:** Shots with $>3$ defects are discarded ($\sim$93% retained); shots where the longest consecutive $|r\rangle$ chain in any single row or column exceeds 4 sites are also discarded ($\sim$92% retained). Combined with rearrangement filtering: **86% retention** at short hold times, dropping to **63%** at $t = 1.16\ \mu$s ($\Delta/\Omega = 4$) due to Rydberg-state decay.
...
| Boundary light-shift | 12(2) MHz (differential AC Stark, $5S_{1/2}$–$5P_{3/2}$) | Methods |
