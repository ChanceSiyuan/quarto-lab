...
3. **Phase-diagram scan:** Global detuning swept over $R_b/a \in [1.2, 1.8]$ ($a$ tuned 4.7–7 µm) and $\delta/\Omega$ up to $3.67$ on a **59-atom** kagome patch to map the confinement–deconfinement phase diagram. (Fig. 2e–f use a cut at fixed $\delta/\Omega = 3.67$.)
...
| Phase-diagram detuning range | $\delta/\Omega$ up to $3.67$ (Fig. 2e–f cut at $\delta/\Omega = 3.67$) |
...
| Adiabatic prep time | 3 µs total (2.5 µs linear sweep + 0.5 µs ramp); reduced to 1.5 µs sweep for quench protocol (from Extended Data Fig. 1, not main text) |
