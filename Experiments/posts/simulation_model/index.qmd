...
Perturbative block-diagonalization that derives low-energy effective Hamiltonians from the full Rydberg Hamiltonian. All models below ultimately rest on this framework. See the [detailed notes](../../../theory/Perturbation/Effective_ham.qmd).
...
- Starting from the Néel state $|Z_2\rangle = |rgrg\cdots\rangle$, anomalous revivals signal **quantum many-body scars** (QMBS) — non-thermal eigenstates in an otherwise ergodic spectrum [@bernien2017probing]. refer to the [detailed notes](/theory/Perturbation/ETH.qmd) for more details.
...
|---|---|---|---|
| [Apply VD on pUCCD](puccd.qmd) | draft | 2026-01-19 | TODO: add description |
| [Bosonic Hubbard Model](Boson-Hubbard.qmd) | draft | 2026-03-03 | TODO: add description |
| [Commensurate Density-Wave Phases & Floating Phase](density_wave.qmd) | draft | 2026-03-05 | TODO: add description |
| [Dipolar XY and XXZ Models](XY_XXZ.qmd) | draft | 2026-03-05 | TODO: add description |
| [Dynamical Phenomena in Rydberg Arrays](dynamics.qmd) | draft | 2026-03-05 | TODO: add description |
| [Fermi-Hubbard Model](ferm_Hubbard.qmd) | draft | 2026-02-28 | TODO: add description |
| [Honeycomb Model](honeycomb.qmd) | draft | 2026-03-03 | Notes on the honeycomb model and its equivalence to a free Majorana fermion Hamiltonian. |
| [Lattice Gauge Theories in Rydberg Arrays](LGT.qmd) | draft | 2026-03-05 | TODO: add description |
| [Optimization: Maximum Independent Set on Rydberg Arrays](optimization.qmd) | draft | 2026-03-05 | TODO: add description |
| [Topological Phases in Rydberg Arrays](topological.qmd) | draft | 2026-03-05 | TODO: add description |
| [Transverse Field Ising Model](TFIM.qmd) | draft | 2026-03-02 | TODO: add description |
