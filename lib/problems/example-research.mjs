import exampleProblem from "../../examples/showcase/problems/Prob-000/problem.json" with { type: "json" };
import exampleManifest from "../../examples/showcase/problems/Prob-000/example.json" with { type: "json" };
import attempt001 from "../../examples/showcase/problems/Prob-000/attempts/ATT-001/attempt.json" with { type: "json" };
import attempt002 from "../../examples/showcase/problems/Prob-000/attempts/ATT-002/attempt.json" with { type: "json" };
import attempt003 from "../../examples/showcase/problems/Prob-000/attempts/ATT-003/attempt.json" with { type: "json" };
import attempt004 from "../../examples/showcase/problems/Prob-000/attempts/ATT-004/attempt.json" with { type: "json" };
import attempt005 from "../../examples/showcase/problems/Prob-000/attempts/ATT-005/attempt.json" with { type: "json" };
