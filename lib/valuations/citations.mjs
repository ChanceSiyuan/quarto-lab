...
export function calculateCitationMetrics(papers, { currentYear } = {}) {
  ...
  const components = {
    ...
    breadth: { availability: "known", value: breadthValue, weight: COMPONENT_WEIGHTS.breadth, unit: "fraction", paperBreadth, institutionBreadth, paperCount: weightedPapers.length, institutionCount: independentInstitutionIds.length },
  ...
  const scientificDemand = components.influence.availability !== "known"
