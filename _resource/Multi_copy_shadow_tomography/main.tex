...
\color{red}Finally, we establish a local obstruction: the relevant lifted operators have non-product structure, and we prove that two-copy local 3-design strategies incur exponential cost $\sim (11/3)^n$ for estimating $\tr(P\rho^2)$.\color{black}
\end{abstract}
\date{\today}
\maketitle
