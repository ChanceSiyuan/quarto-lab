...
We now apply the Schrieffer-Wolff effective Hamiltonian framework ([Lemma subspace-proximity](/theory/Dynamics/Effective_ham.qmd#lem-subspace-proximity), [Lemma direct-rotation](/theory/Dynamics/Effective_ham.qmd#lem-direct-rotation), [Lemma perturbation_expand](/theory/Dynamics/Effective_ham.qmd#lem-perturbation_expand)) to the Kitaev honeycomb model under a weak magnetic field perturbation [@kitaev2006anyons].
