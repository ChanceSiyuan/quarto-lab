...
Using Pauli commutation $\sigma_{\mathbf{p}}\sigma_{\mathbf{p}'} = (-1)^{[\mathbf{p},\mathbf{p}']}\sigma_{\mathbf{p}'}\sigma_{\mathbf{p}} = (-1)^{[\mathbf{p},\mathbf{p}']}\sigma_{\mathbf{p}+\mathbf{p}'}$ (up to phase), the covariance operator factorizes:
$$
  \begin{align*}
