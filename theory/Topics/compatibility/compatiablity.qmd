...
Given $n$-qubit anticommuting Pauli observables $P,Q$ ($\{P,Q\}=0$) with unsharp POVM elements $M_j = \frac{\mathbb{I}+(-1)^{j+1} 3\varepsilon P}{2^n}$ and $N_k = \frac{\mathbb{I}+(-1)^k 3\varepsilon Q}{2^n}$ for $\varepsilon\in[0,1/3]$ (so $M_0 = \frac{\mathbb{I}-3\varepsilon P}{2^n}$, matching the convention @eq-optimization), the generalized compatibility robustness is
$$
