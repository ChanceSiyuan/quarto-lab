...
We now apply the Schrieffer-Wolff effective Hamiltonian framework ([Lemma subspace-proximity](../Perturbation/Effective_ham.qmd#lem-subspace-proximity), [Lemma direct-rotation](../Perturbation/Effective_ham.qmd#lem-direct-rotation), [Lemma perturbation_expand](../Perturbation/Effective_ham.qmd#lem-perturbation_expand)) to the Kitaev honeycomb model under a weak magnetic field perturbation [@kitaev2006anyons].
