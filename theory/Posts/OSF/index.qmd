...
\end{align*}
$$
Then use the fact that $PQ$ has vectorization $v_Q+ v_P \mod 2$ up to a global non-linear phase $i^{[v_Q,v_P]} (-1)^{d(v_Q, v_P)}$ (The exact proof of this identity may refer to here [#eq-pauli-multiplication](/theory/Posts/Shadow_tomography/3desgin_multi_local_shadow.qmd#eq-pauli-multiplication)).
