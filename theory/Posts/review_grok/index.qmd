...
$$ {#eq-agop}
The AGOP captures the average covariance of the model's gradient with respect to the parameters, projected into input space. It identifies which input directions the model is most sensitive to---i.e., the task-relevant features.
::::
