...
#   nohup theory/Posts/Nosiy_complexity/generate_and_polish.sh > noisy_gen.log 2>&1 &
#
#   # Skip to Phase 2 (scaffold already exists)
#   nohup theory/Posts/Nosiy_complexity/generate_and_polish.sh --start-phase=2 > noisy_gen.log 2>&1 &
#
#   # Skip to Phase 3 only (all .qmd files already written)
#   nohup theory/Posts/Nosiy_complexity/generate_and_polish.sh --start-phase=3 > noisy_gen.log 2>&1 &
#
#   # Dry run
#   theory/Posts/Nosiy_complexity/generate_and_polish.sh --dry-run
#
...
SRC_DIR="theory/Posts/Nosiy_complexity"
OUT_DIR="theory/Topics/Noisy_complexity"
...
REF_DIR="theory/Topics/Shadow_tomography"
