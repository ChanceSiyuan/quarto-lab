...
import { ensureProblemWatchDir, main, watchProblemFiles } from "../tooling/scripts/dev-problem-index.mjs";
...
test("dev index builds reserve the showcase problem ID", async () => {
  const { runIndexBuild } = await import("../tooling/scripts/dev-problem-index.mjs");
  ...
  assert.deepEqual(calls, [{
    ...
    args: [".research-loop/tooling/scripts/build-problem-index.mjs", "--reserve-id", "Prob-000"],
