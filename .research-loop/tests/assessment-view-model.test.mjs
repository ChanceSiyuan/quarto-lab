...
import * as viewModel from "../../src/lib/assessments/view-model.mjs";
...
test("assessment panel does not render bare VAS labels", async () => {
  const source = await readFile(new URL("../../src/app/problems/[id]/assessment-panel.tsx", import.meta.url), "utf8");
