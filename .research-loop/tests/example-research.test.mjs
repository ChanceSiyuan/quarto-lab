...
} from "../../src/lib/problems/example-research.mjs";
import {
  buildAttemptDossier,
  ...
  formatSpeedup,
  formatVerified,
} from "../../src/lib/problems/example-presentation.mjs";
...
test("static example formatting is stable for route rendering", () => {
  ...
  assert.equal(
    ...
    ".research-loop/fixtures/showcase/problems/Prob-000/attempts/ATT-003/LOG.md",
  );
});
...
test("attempt dossier includes audit metadata and display sections", () => {
  ...
  assert.deepEqual(dossier.artifacts, [
    ".research-loop/fixtures/showcase/problems/Prob-000/attempts/ATT-004/attempt.json",
    ".research-loop/fixtures/showcase/problems/Prob-000/attempts/ATT-004/LOG.md",
  ]);
});
