...
const pagePath = new URL("../../src/app/qec-portfolio/page.tsx", import.meta.url);
const panelPath = new URL("../../src/app/qec-portfolio/portfolio-panel.tsx", import.meta.url);
const cssPath = new URL("../../src/app/qec-portfolio/portfolio-panel.module.css", import.meta.url);
