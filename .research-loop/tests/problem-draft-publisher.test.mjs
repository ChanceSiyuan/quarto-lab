...
import {
  ...
  publishStagedDraft,
} from "../../src/lib/problems/draft-publisher.mjs";
...
test("CLI publishes a complete staged draft as one JSON object", async () => {
  ...
  const child = spawnSync(process.execPath, [
    ".research-loop/tooling/scripts/publish-problem.mjs",
...
test("CLI reports missing publish arguments as one JSON error object", () => {
  const child = spawnSync(process.execPath, [".research-loop/tooling/scripts/publish-problem.mjs"], {
    cwd: resolve("."),
    encoding: "utf8",
  });
