...
Each infrastructure manifest pins `runtime.image` to an immutable OCI digest;
the selected image must already exist locally and mutable tags are forbidden.
