...
$$ {#eq-ntk-dynamics}
In the infinite-width limit with appropriate parameterization, $K_t$ converges to a deterministic kernel $K_\infty$ that remains constant throughout training [@jacot2018neural], as proved in [here](NTK.qmd)
...
The explicit LLC formulas of @thm-llc-overparameterized and @thm-llc-feature apply to two-layer quadratic networks. Can analogous closed-form LLC bounds be derived for transformer architectures, where the attention mechanism introduces additional symmetries and singularities? The multiplicity $m$ in @eq-llc-volume may carry nontrivial information about the attention head structure [@cullen2026grokking; @liam2025slt].
:::
