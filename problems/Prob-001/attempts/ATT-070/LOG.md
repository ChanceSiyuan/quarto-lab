...
- Algorithm: `run100-proposal-070`
- Branch: `autoresearch/css-distance/run100-proposal-070`
- Created: `2026-07-21T23:33:31Z`
...
- Run: fresh proposal `070` of `100`.
- Model: `gpt-5.5` in the pinned public proposal image.
- Containment canary: `passed` for host-path and outbound-network denial.
- Exploration theme: randomized meet-in-the-middle support assembly without exact enumeration.
...
- crashes: 0
- invalid_claims: 0
- weighted_target_hits: 18
- normalized_quality: 0.9441519567597153
- runtime_seconds: 76.54608824994648
