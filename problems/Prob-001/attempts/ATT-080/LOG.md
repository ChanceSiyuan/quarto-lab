...
- Algorithm: `run100-proposal-080`
- Branch: `autoresearch/css-distance/run100-proposal-080`
- Created: `2026-07-22T00:25:31Z`
...
- Run: fresh proposal `080` of `100`.
- Model: `gpt-5.5` in the pinned public proposal image.
- Containment canary: `passed` for host-path and outbound-network denial.
- Exploration theme: portfolio hybrid of structurally distinct randomized upper-bound heuristics.
...
- accepted: True
- runs: 24
- verified_witnesses: 23
- target_hits: 23
- timeouts: 1
- crashes: 0
- invalid_claims: 0
- weighted_target_hits: 23
- normalized_quality: 0.9583333333333334
- runtime_seconds: 310.62624716595747
