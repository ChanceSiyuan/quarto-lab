...
- Algorithm: `run100-proposal-024`
- Branch: `autoresearch/css-distance/run100-proposal-024`
- Created: `2026-07-21T19:08:44Z`
...
- Run: fresh proposal `024` of `100`.
- Model: `gpt-5.5` in the pinned public proposal image.
- Containment canary: `passed` for host-path and outbound-network denial.
- Exploration theme: belief-propagation inspired reliability ordering with randomized restarts.
...
- crashes: 0
- invalid_claims: 0
- weighted_target_hits: 21
- normalized_quality: 0.9671296296296297
- runtime_seconds: 45.864287962263916
