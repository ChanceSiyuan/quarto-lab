...
/** Wire shape generated by Codex CLI 0.145.0 for turn-level overrides. */
...
/** Wire shape generated by Codex CLI 0.145.0 for turn context fragments. */
...
export interface ThreadForkParams extends ThreadStartParams {
  threadId: string;
  /** Include this turn and all earlier turns in the new branch. */
  lastTurnId?: string | null;
  /** Exclude this turn and all later turns from the new branch. */
...
/**
 * Conversation-only rollback. Codex 0.145.0 marks this method deprecated and
 * explicitly does not revert files changed by the removed turns.
 */
